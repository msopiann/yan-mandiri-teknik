    ...
    var rtsJs = {
        ...
        countDown: function () {
            ...
            if (countDown.length) {
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    const endDate =
                        countdownElement.getAttribute("data-end-date");
        ...
        galleryPopUp: function (e) {
            ...
            $nextButton.click(function (event) {
                ...
                var $currentImg = $(
                    '#image-gallery img[src="' + $currentImgSrc + '"]'
                );
                // Finds the next image
                var $nextImg = $(
                    $currentImg.closest(".image").next().find("img")
                );
            ...
            $prevButton.click(function (event) {
                ...
                // Finds the next image
                var $nextImg = $(
                    $currentImg.closest(".image").prev().find("img")
                );
                // Fade in the next image
        ...
        portfolioHOver: function () {
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const projectElements =
                    document.querySelectorAll(".single-project-3");
