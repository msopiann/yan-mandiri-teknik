                ...
                <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="icon" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="file"
                            name="icon" required />
                        <p class="mt-1 text-sm text-gray-500">Upload an icon image file (SVG, PNG, JPG, WEBP)</p>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="image" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="file"
                            name="image" />
                        <p class="mt-1 text-sm text-gray-500">Upload a larger featured image (SVG, PNG, JPG, WEBP)</p>
